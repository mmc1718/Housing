...
def run(hosts, refugees, var=None):
    if MODE is DebugMode.EVENTBASED:
        ...
        rows = hosts.getAllRowsOfView(ViewDef.DEFAULT)
        row = hosts.getRowByGenId('H-000001')
        #row = hosts.getRowByGenId('R-000001')
    ...
    ## this test code for library and is showing how to use this lib. It needs to removed and replaced by actual script
    print("******** Hosts Test **************")
    ...
    print(hosts.getAllRowsOfView(ViewDef.DEFAULT))
    print("\n")
    genId = "H-000001"
    ...
    rows_data = (hosts.getAllRowsOfView(ViewDef.DEFAULT))
    ...
    print ("\n")
    print("All Rows of View: \n")
    print(refugees.getAllRowsOfView(ViewDef.DEFAULT))
    print("\n")
    genId = "R-000002"
    ...
    rows_data = (refugees.getAllRowsOfView(ViewDef.DEFAULT))
